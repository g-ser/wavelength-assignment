...
"""
myAuxiliaryGraph=constructAuxGraph(followed_path)
printGraph(myAuxiliaryGraph)

"""
Estimate the colors that would be needed to color the graph in degree order
"""

estimateColorsDegreeOrder(myAuxiliaryGraph)

"""
Perform coloring of the graph (auxiliary graph) in degree order 
"""

printGraph(myAuxiliaryGraph,coloringGraph(myAuxiliaryGraph,"degree_order")[1])
"""
Estimate the number of the colors needed in case the graph is colored 
in alternate order
"""

estimateColorsAlternateOrder(myAuxiliaryGraph)

"""
Perform coloring in alternate order
"""
printGraph(myAuxiliaryGraph,coloringGraph(myAuxiliaryGraph,"alternate_order")[1])

"""
Color the predefined routes of the initial graph based on the results 
of the coloring algorithm in degree order
"""
drawColoredPathsOnGivenGraph(myGraph, myAuxiliaryGraph, followed_path, "degree_order")
...
"""
drawColoredPathsOnGivenGraph(myGraph, myAuxiliaryGraph, followed_path, "alternate_order")
